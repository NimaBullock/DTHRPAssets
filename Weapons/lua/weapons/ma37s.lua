...
SWEP.PrintName			= "MA37 ICWS SOCOM"
SWEP.InfoName			= ""
...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/silver/halo/weapons/unsc/v_ma37s.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_ma37s.mdl"
SWEP.VMPos 				= Vector(0, 0, -1)
SWEP.VMAng 				= Vector(0, 0, 0)
SWEP.IronSightsPos = Vector(-3.74, -5, -1.35)
...
SWEP.Primary.SpreadDiv		= 50
SWEP.Primary.Kick			= 0.1
...
SWEP.VElements = {
	["ammo_counter"] = { type = "Quad", bone = "b_gun", rel = "", pos = Vector(5.432, 0, 7.599), angle = Angle(0, -90, 74.444), size = 0.0075, draw_func = nil}
}
