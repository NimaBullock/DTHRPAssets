...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_ma5b.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_ma5b.mdl"
...
SWEP.Primary.Sound 			= Sound("silver.ma5b_fire")
...
SWEP.Primary.MeleeSwingSound	= Sound( "silver.ma5b_melee" )
...
SWEP.VElements = {
	["ammo_counter"] = { type = "Quad", bone = "frame gun", rel = "", pos = Vector(5, 0, 6.75), angle = Angle(0, -90, 65), size = 0.009, draw_func = nil}
}
