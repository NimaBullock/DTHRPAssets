...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_m7.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_m7.mdl"
SWEP.VMPos 				= Vector(0, 0, -1)
SWEP.VMAng 				= Vector(0, 0, 0)
SWEP.IronSightsPos = Vector(-3.725, 0, 0.2)
SWEP.IronSightsAng = Vector(-1.5, -1, 0)
...
SWEP.Primary.Sound 			= Sound("silver.smg_fire")
