...
SWEP.PrintName			= "M6C/SOCOM 'Automag'"
SWEP.InfoName			= ""
...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_m6cs.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_m6cs.mdl"
...
SWEP.Primary.Sound = Sound("silver.m6cs_fire")
