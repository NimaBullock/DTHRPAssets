...
SWEP.PrintName			= "M392 Designated Marksman Rifle"
SWEP.InfoName			= ""
...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_dmr.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_dmr.mdl"
SWEP.VMPos 				= Vector(0, 0, -1)
SWEP.VMAng 				= Vector(0, 0, 0)
SWEP.IronSightsPos		= Vector(0, -25, 0)
...
SWEP.Primary.Sound 			= Sound("silver.dmr_fire")
SWEP.Primary.DistSound		= Sound("silver.dmr_distant")
