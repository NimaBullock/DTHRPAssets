...
SWEP.PrintName			= "MA5k Carbine/SOCOM"
SWEP.InfoName			= ""
...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_ma5ks.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_ma5ks.mdl"
