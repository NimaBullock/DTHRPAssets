...
SWEP.PrintName			= "M6D Personal Defense System"
SWEP.InfoName			= ""
...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_m6d.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_m6d.mdl"
SWEP.VMPos 				= Vector(0, 2, 1.25)
SWEP.VMAng 				= Vector(0, 0, 0)
SWEP.IronSightsPos = Vector(0, -15, 0)
...
SWEP.Primary.Sound 			= Sound("silver.m6d_fire")
SWEP.Primary.DistSound		= Sound("silver.m6d_distant")
...
SWEP.Primary.MeleeSwingSound	= Sound( "sound.m6d_melee" )
...
SWEP.VElements = {
	["aim"] = { type = "Quad", bone = "frame bone24", rel = "", pos = Vector(30.122, -8.771, 9.199), angle = Angle(90, 0, 0), size = 0.041, draw_func = nil}
}
