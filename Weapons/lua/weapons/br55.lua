...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/silver/halo/weapons/unsc/v_br55.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_br55.mdl"
...
SWEP.Primary.Sound 			= Sound("silver.br55_fire")
SWEP.Primary.DistSound		= Sound("silver.br55_distant")
