...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/silver/halo/weapons/unsc/v_ma37.mdl"
SWEP.WorldModel			= "models/silver/halo/weapons/unsc/w_ma37.mdl"
...
SWEP.Primary.Sound			= Sound("silver.ma37_fire")
SWEP.Primary.DistSound 		= Sound("silver.ma37_fire")
